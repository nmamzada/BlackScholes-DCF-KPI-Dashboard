...
which leads to the simulated path
...
- **Ticker-driven workflow**  
  ...
  - Historical OHLCV data, free cash flow, and basic company fundamentals are fetched automatically via `yfinance`.
...
- **Black–Scholes Option Pricer**  
  - Calculates theoretical call and put prices given \( S, K, T, r, q, \sigma \).  
